      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute right-3 md:right-3 w-10 rounded-full bg-white dark:bg-zinc-800 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-neutral-200 dark:bg-violet-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-linear-to-t from-blue-500 via-emerald-500 to-transparent from-0% via-10% rounded-full"
          />
        </div>
      </div>
    </div>
