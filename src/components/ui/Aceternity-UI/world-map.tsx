...
export function WorldMap({ dots = [], lineColor = "#0ea5e9" }: MapProps) {
  ...
  const svgMap = map.getSVG({
    radius: 0.22,
    color: theme === "dark" ? "#0f172a00" : "#555555",
    shape: "circle",
    backgroundColor: theme === "dark" ? "#0f172a00" : "#ffffff00",
  });
  ...
  return (
    <div className="w-full aspect-2/1 dark:bg-[#0f172a00] bg-[#ffffff00] rounded-lg relative font-sans">
      <Image
