// src/components/admin/permissions/permissions-group-view.tsx
"use client";
...
// Helper to get an icon for a resource
const getResourceIcon = (resource: string) => {
  switch (resource.toLowerCase()) {
    ...
    case "article":
      return FileText;
    default:
      return Server; // A generic icon for other resources
  }
};

interface PermissionsGroupViewProps {
  permissions: Permission[];
...
export function PermissionsGroupView({
  permissions,
  onDelete,
  deletingId,
  selectedPermissions,
