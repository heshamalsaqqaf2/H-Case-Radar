...
export default function CardFlip({
  ...
  return (
    ...
    <div
      className="relative w-full max-w-[280px] h-[320px] group rotate-5 transform translate-y-18 hover:rotate-0 hover:translate-y-9 transition duration-700  [perspective:2000px] [transform-style:preserve-3d]"
