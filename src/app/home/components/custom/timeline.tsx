...
import { Timeline } from "@/components/ui/Aceternity-UI/timeline";

export default function TimelineCustom() {
    const data = [
        {
            id: "2024", // أضفنا id فريد لكل عنصر
            title: "2024",
            content: (
                <div>
        ...
        {
            id: "early-2023", // أضفنا id فريد لكل عنصر
            title: "Early 2023",
            content: (
                <div>
                    <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
        ...
        {
            id: "changelog", // أضفنا id فريد لكل عنصر
            title: "Changelog",
            content: (
                <div>
