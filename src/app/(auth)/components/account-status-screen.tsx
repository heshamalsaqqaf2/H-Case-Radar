...
const themes = {
  pending: {
    bg: "bg-[#050b14]/80 backdrop-blur-xl",
    text: "text-slate-200",
    icon: "text-blue-400",
    ...
    button: "bg-blue-500 hover:bg-blue-600 text-white shadow-[0_0_15px_rgba(59,130,246,0.4)]",
  },
  approved: {
    bg: "bg-[#050b14]/80 backdrop-blur-xl",
    text: "text-slate-200",
    icon: "text-[#00f2ff]",
    border: "border border-[#00f2ff]/30",
    ring: "ring-[#00f2ff]/10",
    accent: "from-[#00f2ff]/20 to-emerald-600/20",
    glow: "shadow-[0_0_30px_rgba(0,242,255,0.2)]",
    particle: "bg-[#00f2ff]",
    button: "bg-[#00f2ff] hover:bg-[#00f2ff]/80 text-black font-bold shadow-[0_0_15px_rgba(0,242,255,0.4)]",
  },
  rejected: {
    bg: "bg-[#050b14]/80 backdrop-blur-xl",
    text: "text-slate-200",
    ...
    particle: "bg-red-500",
    button: "bg-red-500 hover:bg-red-600 text-white shadow-[0_0_15px_rgba(239,68,68,0.4)]",
  },
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 dark:bg-black/50">
      ...
      >
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <FloatingParticle key={i.toString()} theme={variant} delay={i * 0.2} />
        ))}
        ...
        <motion.div
          ...
          className="flex items-center justify-center p-6 rounded-full bg-white/70 dark:bg-slate-800/60 shadow-lg relative z-10"
        >
          {animated ? (
            <motion.div
