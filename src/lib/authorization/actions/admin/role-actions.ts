...
//     // TODO: Add audit log
//     await createAuditLog(AUDIT_LOG_ACTIONS.ROLE.CREATE, "role", role.id, {
//       name: role.name,
...
//     await createAuditLog(AUDIT_LOG_ACTIONS.ROLE.UPDATE, "role", role.id, {
//       name: role.name,
//       description: role.description,
//       isDefault: role.isDefault,
//     });
...
//     // TODO: Add audit log
//     await createAuditLog(AUDIT_LOG_ACTIONS.ROLE.DELETE, "role", roleId, {
//       deletedAt: new Date().toISOString(),
//     });
